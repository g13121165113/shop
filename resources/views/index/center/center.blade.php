...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<link type="text/css" rel="stylesheet" href="/in/css/style.css" />
    <!--[if IE 6]>
		...
		<div class="m_right">
        	<div class="m_des">
            	<table border="0" style="width:870px; line-height:22px;" cellspacing="0" cellpadding="0">
                  <tr valign="top">
                    <td width="115"><img src="/in/images/user.jpg" width="90" height="90" /></td>
                    <td>
                    	<div class="m_user">{{$data['username']}}</div>
                        <p>
                            等级：注册用户 <br />
